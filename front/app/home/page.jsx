      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        >
          ...
          <div className="flex items-center flex-wrap gap-2">
            ...
            <Link href="/visiteur" className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border ${brd} ${tc} text-sm font-medium ${hoverCard} transition-all backdrop-blur-sm`}>
              <Users size={16} /> Visiteurs
            </Link>
            <Link href="/visite" className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border ${brd} ${tc} text-sm font-medium ${hoverCard} transition-all backdrop-blur-sm`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className={`flex items-center justify-between px-6 py-4 border-b ${brd} bg-gradient-to-r from-transparent via-purple-500/5 to-transparent`}>
              ...
              <Link href="/service" className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-colors flex items-center gap-1">
              ...
              {servicesList.length === 0 ? (
                ...
                servicesList.slice(0, 8).map((s, idx) => (
                  ...
                  >
                    ...
                    <Link
                      href={`/visiteur?service=${s.id_lieu}`}
        ...
        >
          <div className={`flex items-center justify-between px-6 py-4 border-b ${brd} bg-gradient-to-r from-transparent via-blue-500/5 to-transparent`}>
            ...
            <Link href="/visite" className="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors flex items-center gap-1">
              Voir tout <ArrowRight size={14} />
            </Link>
          </div>
