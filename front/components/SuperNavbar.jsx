...
import {
  Menu, X, Moon, Sun, LogOut, User,
  LayoutDashboard, Users, Building2, BarChart3, Info,
} from 'lucide-react';
...
export default function SuperNavbar() {
  ...
  const links = [
    ...
    { href: '/superAdmin/utilisateurs', label: 'Utilisateur', icon: Users },
    { href: '/visiteur', label: 'Visiteur', icon: Users },
    { href: '/superAdmin/service', label: 'Service', icon: Building2 },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg hidden sm:block">Super Admin</span>
          </div>
